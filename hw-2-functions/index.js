...
// Create function that receives two numbers, and two callbacks
  // It should check if two numbers are real numbers and return result of the second callback.
  // In case it's not a numbers - it should return error message with firstCallback
