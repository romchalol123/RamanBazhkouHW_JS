...
describe('Operators tests', () => {
  describe('when sum', () => {
    xit('should return sum of numbers', () => {
  ...
  describe('when isNumberEven', () => {
    xit('should return if number is even', () => {
  ...
  describe('when findLargestNumber', () => {
    xit('should return largest number', () => {
  ...
  describe('when findTriangleType', () => {
    xit('should return triangle type', () => {
  ...
  describe('when operation', () => {
    xit('should return if return of two numbers and operation', () => {
